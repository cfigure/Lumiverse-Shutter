...
export const SHUTTER_CSS = `
   ...
   overflows the 520px height cap and brings back the scrollbar. */
    ...
    .sh-image-prompt-readonly { box-sizing: border-box; cursor: text; background: var(--lumiverse-fill-subtle, rgba(255, 255, 255, 0.035)); border-color: var(--lumiverse-border-subtle, rgba(255, 255, 255, 0.08)); }
